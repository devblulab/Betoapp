...
const useStyles = makeStyles((theme) => ({
  ...
  logoImg: {
    ...
    height: 50,
    borderRadius: 14,
    boxShadow: '0 0 20px rgba(76, 148, 62, 0.4)',
    border: '1.5px solid rgba(33,243,172,0.3)',
    background: '#fff',
    objectFit: 'cover',
  },
  navMainBtns: {
  ...
  navBtn: {
    ...
    letterSpacing: 1,
    borderRadius: 18,
    background: 'linear-gradient(120deg,#21f3ac 40%,#ffd700 120%)',
    boxShadow: '0 0 18px rgba(33,243,172,0.12)',
    padding: theme.spacing(1.8, 2.3),
    margin: theme.spacing(0, 1),
    border: '1.7px solid rgba(33,243,172,0.2)',
    transition: '0.25s',
    textTransform: 'none',
    '&:hover': {
      color: '#191e20',
...
export default function Header() {
  ...
  const usuario = {
    nome: 'Beto Dheon',
    email: 'contato@betodheon.com.br',
    ...
    <>
      ...
      >
        <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" height="100%">
          <Avatar src={usuario.imagemUrl} style={{ width: 70, height: 70, margin: 20, border: '2.7px solid #ffd700cc' }} alt={usuario.nome} />
          {mainButtons.map((btn) => (
            <Button
              key={btn.href}
              href={btn.href}
              ...
              style={{
                ...
                fontWeight: 900,
                borderRadius: 32,
                background: 'linear-gradient(80deg,#21f3ac 50%,#ffd700 160%)',
                color: '#191e20',
                margin: "18px 0",
                padding: "22px 22px",
                border: '2px solid #21f3ac99',
                boxShadow: '0 0 28px rgba(33,243,172,0.25)',
                letterSpacing: 1.7,
